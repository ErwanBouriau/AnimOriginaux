 ...
 */
final class Version20200402224008 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__location AS SELECT id, animal_id, user_id FROM location');
        ...
        $this->addSql('INSERT INTO location (id, animal_id, user_id) SELECT id, animal_id, user_id FROM __temp__location');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_5E9E89CBA76ED395');
        $this->addSql('DROP INDEX UNIQ_5E9E89CB8E962C16');
        $this->addSql('CREATE TEMPORARY TABLE __temp__location AS SELECT id, user_id, animal_id FROM location');
        $this->addSql('DROP TABLE location');
        ...
        $this->addSql('INSERT INTO location (id, user_id, animal_id) SELECT id, user_id, animal_id FROM __temp__location');
        $this->addSql('DROP TABLE __temp__location');
        $this->addSql('CREATE INDEX IDX_5E9E89CBA76ED395 ON location (user_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_5E9E89CB8E962C16 ON location (animal_id)');
    }
